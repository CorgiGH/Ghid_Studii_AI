  ...
  return (
    ...
    >
      {prev ? (
        ...
        >
          ...
          <div className="text-left">
            <div className="text-[10px]" style={{ color: 'var(--theme-muted-text)' }}>{t('Previous', 'Anteriorul')}</div>
      ...
      {next ? (
        ...
        >
          <div>
            <div className="text-[10px]" style={{ color: 'var(--theme-muted-text)' }}>{t('Next', 'Următorul')}</div>
