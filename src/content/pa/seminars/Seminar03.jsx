...
export default function Seminar03() {
  ...
  const mc9b = [{
    ...
    options: [
      ...
      { text: { en: '3-CNF SAT is hard (NP-complete) but 3-DNF SAT is easy; vice versa for validity', ro: '3-CNF SAT este greu (NP-complet) dar 3-DNF SAT este ușor; invers pentru validitate' }, correct: false, feedback: { en: 'The complexity claim is true, but it describes a *consequence*, not the *key difference*. The key difference is the logical structure: ∃ over AND-of-ORs vs ∀ over OR-of-ANDs; the complexity flip follows from that structure.', ro: 'Afirmația despre complexitate e adevărată, dar descrie o *consecință*, nu *diferența cheie*. Diferența cheie este structura logică: ∃ peste ȘI-de-SAU vs ∀ peste SAU-de-ȘI; inversarea complexității decurge din această structură.' } },
    ],
    explanation: {
