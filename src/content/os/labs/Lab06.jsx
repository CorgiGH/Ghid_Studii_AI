...
export default function Lab06() {
  ...
  return (
    <>
      ...
      <Section title="Ex 1: MyTr_mmap" id="lab_6-ex1" checked={!!checked['lab_6-ex1']} onCheck={() => toggleCheck('lab_6-ex1')}>
      ...
      <Section title="Ex 2: MyHead_mmap" id="lab_6-ex2" checked={!!checked['lab_6-ex2']} onCheck={() => toggleCheck('lab_6-ex2')}>
      ...
      <Section title="Ex 3: MyWc_mmap" id="lab_6-ex3" checked={!!checked['lab_6-ex3']} onCheck={() => toggleCheck('lab_6-ex3')}>
      ...
      <Section title="Ex 4: MyCp_mmap" id="lab_6-ex4" checked={!!checked['lab_6-ex4']} onCheck={() => toggleCheck('lab_6-ex4')}>
      ...
      <Section title="Ex 5: MyCS_shmem #1" id="lab_6-ex5" checked={!!checked['lab_6-ex5']} onCheck={() => toggleCheck('lab_6-ex5')}>
      ...
      <Section title={t('Ex 6: Parallel Sorting with shared memory', 'Ex 6: Sortare paralelă cu memorie partajată')} id="lab_6-ex6" checked={!!checked['lab_6-ex6']} onCheck={() => toggleCheck('lab_6-ex6')}>
      ...
      <Section title="Ex 7: MyCREW_shmem" id="lab_6-ex7" checked={!!checked['lab_6-ex7']} onCheck={() => toggleCheck('lab_6-ex7')}>
      ...
      <Section title={t('Ex 8: Ping-Pong with anonymous mmap', 'Ex 8: Ping-Pong cu mmap anonim')} id="lab_6-ex8" checked={!!checked['lab_6-ex8']} onCheck={() => toggleCheck('lab_6-ex8')}>
      ...
      <Section title={t('Ex 9: Token Ring with anonymous mmap', 'Ex 9: Token Ring cu mmap anonim')} id="lab_6-ex9" checked={!!checked['lab_6-ex9']} onCheck={() => toggleCheck('lab_6-ex9')}>
