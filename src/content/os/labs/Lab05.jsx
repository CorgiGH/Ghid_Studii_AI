...
export default function Lab05() {
  ...
  return (
    <>
      ...
      <Section title={t('Ex 1: A particular tree of processes', 'Ex 1: Un arbore particular de procese')} id="lab_5-ex1" checked={!!checked['lab_5-ex1']} onCheck={() => toggleCheck('lab_5-ex1')}>
      ...
      <Section title={t('Ex 2: Perfect k-ary tree (recursive)', 'Ex 2: Arbore k-ar perfect (recursiv)')} id="lab_5-ex2" checked={!!checked['lab_5-ex2']} onCheck={() => toggleCheck('lab_5-ex2')}>
...
// k=2, d=3 → binary tree with 2^3-1 = 7 internal nodes`}</Code>
      ...
      <Section title={t('Ex 3: Perfect k-ary tree (iterative)', 'Ex 3: Arbore k-ar perfect (iterativ)')} id="lab_5-ex3" checked={!!checked['lab_5-ex3']} onCheck={() => toggleCheck('lab_5-ex3')}>
      ...
      <Section title={t('Ex 4: Exec command — cut', 'Ex 4: Exec command — cut')} id="lab_5-ex4" checked={!!checked['lab_5-ex4']} onCheck={() => toggleCheck('lab_5-ex4')}>
      ...
      <Section title="Ex 5: MyCall_System" id="lab_5-ex5" checked={!!checked['lab_5-ex5']} onCheck={() => toggleCheck('lab_5-ex5')}>
    ...
    return WEXITSTATUS(st);
      ...
      <Section title={t('Ex 6: Run SPMD programs', 'Ex 6: Rularea programelor SPMD')} id="lab_5-ex6" checked={!!checked['lab_5-ex6']} onCheck={() => toggleCheck('lab_5-ex6')}>
      ...
      <Section title={t('Ex 7: Supervisor-Workers pattern', 'Ex 7: Pattern-ul Supervisor-Workers')} id="lab_5-ex7" checked={!!checked['lab_5-ex7']} onCheck={() => toggleCheck('lab_5-ex7')}>
      ...
      <Section title={t('Ex 8: Ping-Pong pattern', 'Ex 8: Pattern-ul Ping-Pong')} id="lab_5-ex8" checked={!!checked['lab_5-ex8']} onCheck={() => toggleCheck('lab_5-ex8')}>
      ...
      <Section title="Ex 9: MyShell v1" id="lab_5-ex9" checked={!!checked['lab_5-ex9']} onCheck={() => toggleCheck('lab_5-ex9')}>
