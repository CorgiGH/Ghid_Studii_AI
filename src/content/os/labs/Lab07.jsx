...
export default function Lab07() {
  ...
  return (
    <>
      ...
      <Section title={t('Ex 1: Pipe commands #3', 'Ex 1: Comenzi pipe #3')} id="lab7-ex1" checked={!!checked['lab7-ex1']} onCheck={() => toggleCheck('lab7-ex1')}>
...
// Child2: close(pfd[1]), dup2(pfd[0], STDIN), exec(cmd2)`}</Code>
      ...
      <Section title="Ex 2: MyShell v2 (with pipelines)" id="lab7-ex2" checked={!!checked['lab7-ex2']} onCheck={() => toggleCheck('lab7-ex2')}>
      ...
      <Section title={t('Ex 3: Supervisor-Workers with pipes', 'Ex 3: Supervisor-Workers cu pipe-uri')} id="lab7-ex3" checked={!!checked['lab7-ex3']} onCheck={() => toggleCheck('lab7-ex3')}>
      ...
      <Section title={t('Ex 4: Ping-Pong with pipes', 'Ex 4: Ping-Pong cu pipe-uri')} id="lab7-ex4" checked={!!checked['lab7-ex4']} onCheck={() => toggleCheck('lab7-ex4')}>
      ...
      <Section title={t('Ex 5: Supervisor-Workers with FIFOs', 'Ex 5: Supervisor-Workers cu FIFO-uri')} id="lab7-ex5" checked={!!checked['lab7-ex5']} onCheck={() => toggleCheck('lab7-ex5')}>
      ...
      <Section title={t('Ex 6: Ping-Pong with FIFOs', 'Ex 6: Ping-Pong cu FIFO-uri')} id="lab7-ex6" checked={!!checked['lab7-ex6']} onCheck={() => toggleCheck('lab7-ex6')}>
      ...
      <Section title="Ex 7: MyShell v3 (distributed)" id="lab7-ex7" checked={!!checked['lab7-ex7']} onCheck={() => toggleCheck('lab7-ex7')}>
      ...
      <Section title={t('Ex 8: Signal handling basics', 'Ex 8: Bazele tratării signals')} id="lab7-ex8" checked={!!checked['lab7-ex8']} onCheck={() => toggleCheck('lab7-ex8')}>
...
signal(SIGINT, handler);  // or use sigaction`}</Code>
      ...
      <Section title={t('Ex 9: Producer-Consumer with signals', 'Ex 9: Producător-Consumator cu signals')} id="lab7-ex9" checked={!!checked['lab7-ex9']} onCheck={() => toggleCheck('lab7-ex9')}>
      ...
      <Section title={t('Ex 10: Multi-player game', 'Ex 10: Joc multi-player')} id="lab7-ex10" checked={!!checked['lab7-ex10']} onCheck={() => toggleCheck('lab7-ex10')}>
