...
export default function Lab04() {
  ...
  return (
    <>
      ...
      <Section title="Ex 1: MyTr" id="lab_4-ex1" checked={!!checked['lab_4-ex1']} onCheck={() => toggleCheck('lab_4-ex1')}>
      ...
      <Section title="Ex 2: MyHead" id="lab_4-ex2" checked={!!checked['lab_4-ex2']} onCheck={() => toggleCheck('lab_4-ex2')}>
      ...
      <Section title="Ex 3: MyFind #2" id="lab_4-ex3" checked={!!checked['lab_4-ex3']} onCheck={() => toggleCheck('lab_4-ex3')}>
      ...
      <Section title="Ex 4: MyFind #3" id="lab_4-ex4" checked={!!checked['lab_4-ex4']} onCheck={() => toggleCheck('lab_4-ex4')}>
      ...
      <Section title="Ex 5: MyMv" id="lab_4-ex5" checked={!!checked['lab_4-ex5']} onCheck={() => toggleCheck('lab_4-ex5')}>
      ...
      <Section title="Ex 6: MyLs" id="lab_4-ex6" checked={!!checked['lab_4-ex6']} onCheck={() => toggleCheck('lab_4-ex6')}>
      ...
      <Section title="Ex 7: MyCritSec #4" id="lab_4-ex7" checked={!!checked['lab_4-ex7']} onCheck={() => toggleCheck('lab_4-ex7')}>
      ...
      <Section title="Ex 8: MyCREW #1" id="lab_4-ex8" checked={!!checked['lab_4-ex8']} onCheck={() => toggleCheck('lab_4-ex8')}>
      ...
      <Section title="Ex 9: MyCREW #2" id="lab_4-ex9" checked={!!checked['lab_4-ex9']} onCheck={() => toggleCheck('lab_4-ex9')}>
      ...
      <Section title="HW: Octal2Binary filter" id="lab_4-hw1" checked={!!checked['lab_4-hw1']} onCheck={() => toggleCheck('lab_4-hw1')}>
      ...
      <Section title="HW: MyUniq" id="lab_4-hw2" checked={!!checked['lab_4-hw2']} onCheck={() => toggleCheck('lab_4-hw2')}>
      ...
      <Section title="HW: MyTac" id="lab_4-hw3" checked={!!checked['lab_4-hw3']} onCheck={() => toggleCheck('lab_4-hw3')}>
