...
const os = {
  ...
  icon: '\uD83D\uDDA5\uFE0F',
  courses: [
    { id: 'course_1', title: { en: 'Course 1: Basic Linux Commands & Filesystems', ro: 'Cursul 1: Comenzi de bază Linux și sisteme de fișiere' }, shortTitle: { en: 'C1: Commands & FS', ro: 'C1: Comenzi & FS' }, sectionCount: 9, component: lazy(() => import('./courses/Course01.jsx')) },
    { id: 'course_2', title: { en: 'Course 2: Shell Interpreters I - General Overview', ro: 'Cursul 2: Interpretoare de comenzi I - Prezentare generală' }, shortTitle: { en: 'C2: Shell I', ro: 'C2: Shell I' }, sectionCount: 10, component: lazy(() => import('./courses/Course02.jsx')) },
    { id: 'course_3', title: { en: 'Course 3: Bash Scripting', ro: 'Cursul 3: Scripting Bash' }, shortTitle: { en: 'C3: Bash Script', ro: 'C3: Script Bash' }, sectionCount: 9, component: lazy(() => import('./courses/Course03.jsx')) },
    { id: 'course_4', title: { en: 'Course 4: File I/O Primitives (POSIX + C stdlib)', ro: 'Cursul 4: Primitivele I/O pentru fișiere (POSIX + C stdlib)' }, shortTitle: { en: 'C4: File I/O', ro: 'C4: I/O Fișiere' }, sectionCount: 7, component: lazy(() => import('./courses/Course04.jsx')) },
    { id: 'course_5', title: { en: 'Course 5: File Locking & Concurrent Access', ro: 'Cursul 5: Blocaje pe fișiere și acces concurent' }, shortTitle: { en: 'C5: File Locks', ro: 'C5: Blocaje' }, sectionCount: 7, component: lazy(() => import('./courses/Course05.jsx')) },
    { id: 'course_6', title: { en: 'Course 6: Process Management I - fork() & wait()', ro: 'Cursul 6: Gestiunea proceselor I - fork() și wait()' }, shortTitle: { en: 'C6: fork/wait', ro: 'C6: fork/wait' }, sectionCount: 7, component: lazy(() => import('./courses/Course06.jsx')) },
    { id: 'course_7', title: { en: 'Course 7: Process Management II - exec()', ro: 'Cursul 7: Gestiunea proceselor II - exec()' }, shortTitle: { en: 'C7: exec', ro: 'C7: exec' }, sectionCount: 7, component: lazy(() => import('./courses/Course07.jsx')) },
    { id: 'course_8', title: { en: 'Course 8: Memory-Mapped Files, Shared Memory & Semaphores', ro: 'Cursul 8: Fișiere mapate în memorie, memorie partajată și semafoare' }, shortTitle: { en: 'C8: mmap/IPC', ro: 'C8: mmap/IPC' }, sectionCount: 8, component: lazy(() => import('./courses/Course08.jsx')) },
    { id: 'course_9', title: { en: 'Course 9: IPC via Pipes (Anonymous & Named)', ro: 'Cursul 9: Comunicația inter-procese prin pipes (anonime și cu nume)' }, shortTitle: { en: 'C9: Pipes', ro: 'C9: Pipes' }, sectionCount: 8, component: lazy(() => import('./courses/Course09.jsx')) },
    { id: 'course_10', title: { en: 'Course 10: POSIX Signals', ro: 'Cursul 10: POSIX Signals' }, shortTitle: { en: 'C10: Signals', ro: 'C10: Signals' }, sectionCount: 8, component: lazy(() => import('./courses/Course10.jsx')) },
    { id: 'course_11', title: { en: 'Course 11: NCURSES & Terminal Management', ro: 'Cursul 11: NCURSES și gestiunea terminalelor' }, shortTitle: { en: 'C11: ncurses', ro: 'C11: ncurses' }, sectionCount: 8, component: lazy(() => import('./courses/Course11.jsx')) },
  ],
  seminars: [
